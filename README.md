...
No, genes are by far not the only thing shaping our future and looking at variants in isolation has its limitations (some of them are described here [here](SNPedia/templates/start_popup.html) - may be useful if you are wondering whether to download it).
